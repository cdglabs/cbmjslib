...
var clockGUIComponent = {
	...
	kb.askByMeaning(
	    '(and (programVariableHasProperty ?THAT ?P)' 
	       + '(programVariableRepresents ?P ?_' 
		    + '(SubcollectionOfWithRelationToFn Integer secondsSince1970ToDate Now))' 
	       + '(programVariableHasName ?P ?NAME))', 
	    this, found, false, this.onAPIDiscovered) },
    onAPIDiscovered: function(answer) {
	this.foundAPI = answer.NAME
	this.epoch = this.clock[this.foundAPI]()
